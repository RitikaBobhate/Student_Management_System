...
class Developer:
    def __init__(self, root):
        ...
        # Background image
        bg1 = Image.open(r"img\website-background-templates.png")
        ...
        std_b1_1 = Button(bg_img, text="Ritika Bobhate", cursor="hand2", font=("Ritika Bobhate", 15, "bold"), bg="white", fg="navyblue", command=self.show_details)
        std_b1_1.place(x=250, y=380, width=800, height=45)

    def show_details(self):
   
        details_window = Toplevel(self.root)
        details_window.title("Ritika Bobhate")
